...
import { createAuthHooks, type AuthContext, type AuthLayerService } from "./auth.middleware";

function createServer(authService: AuthLayerService, permission = "schema:publish") {
