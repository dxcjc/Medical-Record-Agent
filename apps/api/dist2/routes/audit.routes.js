import { assertRouteResponseObjectList, auditListQuerySchema, redactSensitiveRouteValue } from "./route-dtos";
/**
 * 注册审计查询路由。
 * 审计列表属于敏感运维数据，必须先认证，再显式检查 audit:read 权限。
 */
export async function registerAuditRoutes(server, dependencies) {
    server.get("/audit", {
